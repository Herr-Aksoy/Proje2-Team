...
DATABASES = {
    'default': {
        ...
        'HOST': 'proje2-rds.cn06wsyg8v9j.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'proje2blog' # please enter your s3 bucket name
